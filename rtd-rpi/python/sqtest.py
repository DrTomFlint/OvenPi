...
data1 = [
    (run_number, 1,    50.0,40.0,45.0,45.2,     52.0,53.0,33.0,38.1,     50.5,55.0,54.4,0.123),
    (run_number, 2,    51.0,41.0,46.0,46.2,     53.0,54.0,33.1,39.1,     50.6,55.1,54.5,0.124),
    (run_number, 3,    52.0,42.0,47.0,47.2,     54.0,55.0,33.2,40.1,     50.7,55.2,54.6,0.125),
    (run_number, 4,    53.0,43.0,48.0,48.2,     55.0,56.0,33.3,41.1,     50.8,55.3,54.7,0.126),
]
summary1 = (1, '2023-09-12 10:00:00', 'bake a stealie')

run_number = 2
data2 = [
    (run_number, 1,    150.0,140.0,145.0,145.2,     152.0,153.0,43.0,48.1,     150.5,155.0,154.4,0.223),
    (run_number, 2,    151.0,141.0,146.0,146.2,     153.0,154.0,43.1,49.1,     150.6,155.1,154.5,0.224),
    (run_number, 3,    152.0,142.0,147.0,147.2,     154.0,155.0,43.2,50.1,     150.7,155.2,154.6,0.225),
    (run_number, 4,    153.0,143.0,148.0,148.2,     155.0,156.0,43.3,51.1,     150.8,155.3,154.7,0.226),
    (run_number, 4,    154.0,144.0,149.0,149.2,     156.0,156.0,43.5,51.2,     150.9,155.4,154.8,0.227),
    (run_number, 4,    155.0,145.0,150.0,150.2,     157.0,157.0,43.6,51.3,     151.0,155.5,154.9,0.228),
]
